...
function AppShell() {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (hashPath && ['home', 'know-aicaiml', 'courses', 'learners', 'events-projects', 'membership', 'login', 'member-login', 'member-welcome', 'member-dashboard', 'set-password', 'verification', 'contact', 'privacy', 'terms', 'benefits-view'].includes(hashPath)) {
